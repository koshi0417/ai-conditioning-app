...
const RecoverExtras = (() => {
  ...
  const challengePool = [
    ...
    { id: 'protein', emoji: '🥩', text: 'タンパク質を体重×1.5g摂取する' },
    { id: 'stretch10', emoji: '🧘', text: '10分間ストレッチする' },
    { id: 'sleep22', emoji: '😴', text: '22時前に就寝する' },
    { id: 'sprint5', emoji: '🏃', text: '自主練でスプリント5本走る' },
    { id: 'video15', emoji: '📖', text: '試合映像を15分分析する' },
    { id: 'squat30', emoji: '🦵', text: 'スクワット30回する' },
    { id: 'roller', emoji: '🤸', text: 'フォームローラーで全身ケア' },
    { id: 'breathe10', emoji: '🫁', text: '深呼吸を10回する' },
    { id: 'nophone', emoji: '📵', text: '就寝前1時間スマホを見ない' },
    { id: 'banana', emoji: '🍌', text: '練習30分前にバナナを食べる' },
    { id: 'proteinshake', emoji: '🧴', text: '練習後にプロテインを摂取する' },
    { id: 'shoulder', emoji: '🙆', text: '肩甲骨周りを重点的にほぐす' },
    { id: 'spikes', emoji: '👟', text: 'スパイクのメンテナンスをする' },
    { id: 'plank', emoji: '💪', text: 'プランク1分×3セットする' },
    { id: 'core', emoji: '🔄', text: '体幹トレーニング10分する' },
  ];
